"use strict";			// enforce declared variables
...
// traverses through all projects
...
function extractAlignedSequences(inputDirectory) {
    ...
    let files = [];
    walkSync(inputDirectory, files);		// saves all JavaScript and TypeScript files to files
...
// find all JavaScript or TypeScript files in dir and add them to filelist
